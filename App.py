...
with open('E:/Movie_Recommender_App-master/Movie_Recommender_App-master/Data/movie_data.json', 'r+', encoding='utf-8') as f:
    data = json.load(f)
with open('E:/Movie_Recommender_App-master/Movie_Recommender_App-master/Data/movie_titles.json', 'r+', encoding='utf-8') as f:
...
def run():
    img1 = Image.open('E:/Movie_Recommender_App-master/Movie_Recommender_App-master/meta/logo.jpg')
